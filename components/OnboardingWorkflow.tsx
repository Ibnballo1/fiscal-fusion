  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* Progress Steps */}
        <div className="flex items-center justify-center mb-8 w-1/2 mx-auto relative">
        ...
        <div className="space-y-6">
          {currentStep === 1 && (
            <>
              ...
              <Card className="p-0 overflow-hidden">
                <div
                  className={`bg-green-50 border-2 border-dashed transition-colors ${
                    dragOver
          ...
          {currentStep === 3 && (
            <>
              <h1 className="text-2xl font-semibold text-gray-900">Approval</h1>
          ...
          <div>
            {currentStep < 3 ? (
              <Button
                ...
                onClick={() => setCurrentStep(currentStep + 1)}
              >
                {currentStep === 1 ? "Review Application" : "Approval Summary"}
              </Button>
            ) : (
